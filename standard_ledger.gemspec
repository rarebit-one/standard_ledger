...
Gem::Specification.new do |spec|
  ...
  spec.description = "StandardLedger captures the recurring 'append-only entry → N projection updates' pattern as a declarative DSL on host ActiveRecord models. Supports inline, async, sql, trigger, and matview projection modes; enforces idempotency-by-unique-index; and provides a deterministic rebuild path from the entry log."
  spec.license     = "MIT"
